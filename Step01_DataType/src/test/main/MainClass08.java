package test.main;
/*
 *  java 에서 기본 데이터 type 8개를 제외한 나머지는 모두 참조 데이터 type 이다.
 *  
 ...
 *  메소드 호출을 javascript 에서 함수 호출과 유사하다.
 *  
 *  자바에서는 메소드를 변수를 담을 수 없다.
 * */
public class MainClass08 {
	public static void main(String[] args) {
		...
		//String 객체의 메소드를 활용해서 str 변수 안에 있는 문자를 
		//모두 대문자(UpperCase)로 변환해서 str2 라는 이름의 변수에 담아 보세요
		String result3=str.toUpperCase();
		System.out.println(result3);
		// --------------------------------
		String greet="Hello! mimi, Bye! mimi";
		//위의 문자열에서 mimi 라는 문자열을 mama 라는 문자열로 교체 해서 결과를 greet2에 
		// 담아보세요. String 객체의 메소드를 활용해서
		//System.out.println(greet.replace('i','a'));
		//System.out.println(greet.replace("mimi","mama"));
		String greet2=greet.replace("mimi","mama");
		//----------------------------------
		String message="My name is Kim-kideok";
		// 1. 위의 문자열이 My 라는 문자열로 시작 하는지 여부(true or false)를 isStart 라는 변수에 담아보세요.
		// 2. 위의 문자열에서 i 가 문자열의 몇 번째 인덱스에 위치하고 있는지를 index 라는 변수에 담아 보세요.
		// 1.
