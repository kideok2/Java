 ...
 */
public class MainClass01 { // <- text file임 자바에서는 java source file      하늘색으로 써진 단어들은 예약어
	public static void main(String[] args) {
		...
		int iInt=100;
		long iLong=10;
		/* int type 변수에 byte type 변수에 내용을 대입한다면?
		...
		float num1= 10.1f;
		double num2=10.2d;
		double num3=10.3; //d, f 를 붙이지 않으면 double type으로 간주 된다.
